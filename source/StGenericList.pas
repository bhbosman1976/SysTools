...
uses
  Windows, SysUtils, Classes, StConst, StGenericBase, stBase;
...
type
  ...
  public
    constructor Create(const AData: TData); virtual;
...
constructor TStListNode<TData>.Create(const AData: TData);
begin
